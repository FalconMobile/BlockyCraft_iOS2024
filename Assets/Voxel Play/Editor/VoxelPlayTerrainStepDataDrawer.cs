			...
			if (enabled.boolValue) {
				...
				switch (stepType.intValue) {
					...
					case (int)TerrainStepType.Island:
						...
						break;
					case (int)TerrainStepType.OffsettedIsland:
						position.y += lineHeight;
						EditorGUI.PropertyField(position, property.FindPropertyRelative("param"), new GUIContent("param1", "some param data 1"));
						position.y += lineHeight;
						EditorGUI.PropertyField(position, property.FindPropertyRelative("param2"), new GUIContent("param2", "some param data 2"));
						position.y += lineHeight;
						EditorGUI.PropertyField(position, property.FindPropertyRelative("offset"), new GUIContent("Offset", "Some offset"));
						break;
