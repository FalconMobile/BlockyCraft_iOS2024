...
namespace VoxelPlay
{
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour
    {
        ...
        void LoadGameBinaryFileFormat_11 (BinaryReader br, bool preservePlayerPosition = false)
        {
            ...
            for (int c = 0; c < numChunks; c++) {
                ...
                for (int k = 0; k < numWords; k++) {
                    ...
                    Vector3 voxelAngles = Misc.vector3zero;
                    if (hasCustomRotation == 1) {
                        voxelAngles = DecodeVector3Binary (br);
                    }
