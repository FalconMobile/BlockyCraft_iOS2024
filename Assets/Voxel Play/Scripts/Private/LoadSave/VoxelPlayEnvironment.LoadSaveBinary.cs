...
namespace VoxelPlay
{
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour
    {
        ...
        private const byte SAVE_FILE_CURRENT_FORMAT = 14;
        private bool _isLoadingGame;

        public bool LoadGameBinary(bool firstLoad, bool preservePlayerPosition = false, string nameGameMap = null)
        {
            if (nameGameMap != null)
            {
                saveFilename = nameGameMap;
            }
...
#pragma warning disable 0162
                    ...
                    if (version >= 10)
                    {
                        ...
                        {
                            throw new ApplicationException("Saved game cannot be loaded. Saved chunk size (" +
                                                           chunkSize + ") does not match current scene chunk size!");
                        }
                    }
...
#pragma warning restore 0429
            ...
            {
                ShowError("<color=red>Load error:</color> <color=orange>" + ex.Message + "</color><color=white>" +
                          ex.StackTrace + "</color>");
                result = false;
            }
        ...
        byte[] GetSaveGameDataBinary()
        {
			...
			return File.ReadAllBytes (path);
																...
																string resource =
 "Worlds/" + world.name + "/SavedGames/" + saveFilename;
        ...
        public bool SaveGameBinary(string MapName = null)
        {
            if (MapName != null)
            {
        ...
        public bool LoadGameFromBase64(string saveGameDataBase64string, bool preservePlayerPosition,
