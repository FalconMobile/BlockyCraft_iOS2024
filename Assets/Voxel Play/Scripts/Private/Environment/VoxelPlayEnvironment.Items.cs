...
namespace VoxelPlay
{
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour
    {
        ...
        /// </summary>
        static Dictionary<string, ItemDefinition> itemDefinitionsDict;
        ...
        {
            if (voxelDefinition == null || itemDefinitionsDict.ContainsKey(voxelDefinition.name))
            {
                return false;
            }
        ...
        GameObject TorchAttachInt(VoxelHitInfo hitInfo, ItemDefinition torchDefinition = null, bool refreshChunks = true)
        {
            ...
            torch.transform.position = placeholderTransform.position + hitInfo.normal * 0.5f;
            ...
            // Trigger torch event
            if (!_isLoadingGame && captureEvents && OnTorchAttached != null)
            {
