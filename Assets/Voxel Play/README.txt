...
Version 9.8 24/5/2021
- Added VP Model Texture BumpMap shader
- Added emission option to VP Model shaders
- Added enableGeneration option to Voxel Play Environment inspector
- Chunk's isPopulated state is now store in the savegame to support proper reconstruction of chunks modified after using GetChunkUnpopulated API
...
- [Fix] Fixed Voxel Play Behaviour unstuck option changes that produces stuttering on some characters

Version 9.6 30/4/2021
...
- Voxel structure can now be extended with additional fields
...
Version 9.5.1 10/4/2021
- [Fix] Fixes

Version 9.5 30/3/2021
...
Version 9.3.2 24/MAR/2021
- [Fix] Fixed controller click regression

Version 9.3.1 20/MAR/2021
- API: added VoxelClearProperties, VoxelClearProperty
- [Fix] Fixed raycast issue with custom voxels when underground
- [Fix] Fixed outline rendering issue when relief mapping is enabled

Version 9.3 15/MAR/2021
...
Version 9.1.1 5/MAR/2021
- Improved Item Definition editor UI
- API: added GetVoxelChunkCoordinates overload (converts position to px, py, pz intra-chunk coordinates)
- Internal API improvements and additions
- [Fix] Fixed torch placement issue when placed on rotated voxels

Version 9.0 27/FEB/2021
- Origin shift. New option in Voxel Play Environment. See: https://kronnect.freshdesk.com/a/solutions/articles/42000083890
...
Version 8.4.1
- [Fix] Fixed voxel animation when normals/parallax feature is enabled (thanks to Jeck)
- [Fix] Fixed colliders not refreshing when entire chunk is destroyed using VoxelDestroy method
- [Fix] Fixed regression with input controller not responding to Esc key when it's disabled
...
- Added "Prefab Spawner" detail generator (see: https://kronnect.freshdesk.com/a/solutions/articles/42000081685)
...
Version 8.2
- Ability to combine water and other voxel types in same space. Example: https://youtu.be/rZ7gFNZbzhI
...
- Internal optimizations for multiplayer
...
- Added Bevel effect (enable it in Voxel Play Environment inspector)
...
Version 7.5.1
- Improvements & fixes to water spread
- [Fix] Fixed emitting light voxels
- [Fix] Fixed null exception error when assigning a non-compliant prefab to PC Input Controller

Version 7.5
- Revamped lightmap recalculation system to allow faster updates
...
- Added integration option with Highlight Plus. See: https://kronnect.freshdesk.com/a/solutions/articles/42000076928
...
Version 7.2
- Voxel definition: added "Custom Texture Packing" option. See: https://kronnect.freshdesk.com/support/solutions/articles/42000075603-custom-texture-packing
- Custom save game data now supported. See: https://kronnect.freshdesk.com/a/solutions/articles/42000041550
...
Version 7.1
- New feature: Connected Voxel. See: https://kronnect.freshdesk.com/a/solutions/articles/42000074849
...
- Added support for Universal Rendering Pipeline
- Improved accuracy of biome selection based on altitude and moisture
- Added two more override material shaders examples. See: https://kronnect.freshdesk.com/a/solutions/articles/42000074415
...
6.7
- Improved dense tree option (tree leaves appearance)
- Improved accuracy of noise generation functions
...
- Default biome is now added when creating a new world
